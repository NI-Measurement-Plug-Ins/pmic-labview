# Line Transient Response with Pin Map
...
2. Select the appropriate source and load pin names and update other parameters as needed.  
    ![front panel](images/line-tran-w-pinmap-front-panel.png)
