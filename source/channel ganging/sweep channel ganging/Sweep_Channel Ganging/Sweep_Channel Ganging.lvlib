...
<Library LVVersion="21008000">
	...
	<Item Name="Controls" Type="Folder">
		<Item Name="Sweep fetch measurement control.ctl" Type="VI" URL="../Controls/Sweep fetch measurement control.ctl"/>
		<Item Name="Sweep fetch measurement result.ctl" Type="VI" URL="../Controls/Sweep fetch measurement result.ctl"/>
		<Item Name="Sweep perform meaasurement.ctl" Type="VI" URL="../Controls/Sweep perform meaasurement.ctl"/>
	</Item>
	<Item Name="SubVI" Type="Folder">
		<Item Name="Fetch Measurement-Sweep.vi" Type="VI" URL="../SubVI/Fetch Measurement-Sweep.vi"/>
		<Item Name="Perform Measurement.vi" Type="VI" URL="../SubVI/Perform Measurement.vi"/>
	</Item>
